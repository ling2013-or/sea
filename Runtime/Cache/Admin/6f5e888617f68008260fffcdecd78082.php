...
<section>
    ...
    <div class="page-heading">
        ...
        <ul class="breadcrumb">
            <li>
                <a href="<?php echo U('Sellplan/index');?>">养殖计划</a>
            </li>
            <li class="active">新增养殖计划</li>
        </ul>
    </div>
            ...
            <section class="panel">
                <div class="panel-body">
                    <form role="form" action="<?php echo U();?>" class="form">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label class="item-label" for="begin_time">计划开始时间<span
                                        class="check-tips">（开始执行时间）</span></label>
                                <input type="number" class="form-control" name="begin_time" id="begin_time"
                                       placeholder="0">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <select class="form-control" id="seed" name="goods_id">
                                    <?php if(!empty($goodsList)): if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["id"]); ?>"><?php echo ($row["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        <?php else: ?>
