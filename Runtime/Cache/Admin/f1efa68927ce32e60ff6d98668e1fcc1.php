            ...
            <section class="panel">
                <div class="panel-body">
                    <form role="form" action="<?php echo U();?>" class="form">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label class="item-label">取消原因：</label>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <div class="square single-row icheck">
                                    <div class="radio">
                                        <input tabindex="3" type="radio"  name="state_info" value="不是有效的订单">
                                        <label>不是有效的订单</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <div class="square single-row icheck">
                                    <div class="radio">
                                        <input tabindex="3" type="radio"  name="demo-radio" value="买家主动要求">
                                        <label>买家主动要求</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <div class="square single-row icheck">
                                    <div class="radio">
                                        <input tabindex="3" type="radio"  name="state_info" value="">
                                        <label>其他原因</label>
                                    </div>
                                </div>
                            </div>
