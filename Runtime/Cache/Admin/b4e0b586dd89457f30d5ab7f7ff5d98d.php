                    ...
                    <form role="form" action="<?php echo U();?>" class="form">
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text" class="form-control" name="module_name" id="name">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label class="item-label" for="bind">绑定模块 <span class="check-tips">（请按照格式填写,区分大小写）</span></label>
                                <input type="text" class="form-control" name="module_bind" id="bind" placeholder="Auth/index">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label class="item-label">权限分类<span class="check-tips">（是否作为菜单显示）</span></label>
                                <label><input type="radio" name="is_menu" value="1" checked="true"> 是 </label>
                                &nbsp;
                                <label><input type="radio" name="is_menu" value="0"> 否 </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-4">
                                <label class="item-label" for="icon">显示图标<span class="check-tips">（用于设置顶级菜单的图标,直接点击图标添加）</span></label>
                                 <b class="" style="font-size:30px;" id="icons-img"></b>
                                <input type="hidden" class="form-control" name="module_img" id="icon">
                                <hr>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <input type="number" class="form-control" name="module_index" id="sort" value="0">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <select class="form-control" id="group" name="parent_id">
                                    ...
                                    <?php if(is_array($moduleIndex)): $i = 0; $__LIST__ = $moduleIndex;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$parent): $mod = ($i % 2 );++$i;?><option value="<?php echo ($parent["module_id"]); ?>"><?php echo ($parent["module_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
