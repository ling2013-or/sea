                    ...
                    <form role="form" action="<?php echo U();?>" class="form">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <label><input type="radio" name="type" value="0" <?php if($info["status"] == 0): ?>checked<?php endif; ?>> 轮播图</label>&nbsp;
                                <label><input type="radio" name="type" value="1" <?php if($info["status"] == 1): ?>checked<?php endif; ?>> 活动图片</label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4">
                                ...
                                <label><input type="radio" name="status" value="0" <?php if($info["status"] == 0): ?>checked<?php endif; ?>> 未发布</label>&nbsp;
                                <label><input type="radio" name="status" value="1" <?php if($info["status"] == 1): ?>checked<?php endif; ?>> 已发布</label>
                            </div>
                        </div>
                            ...
                            <div class="form-group col-lg-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-footer" id="img_show_multi">
                                        <?php if(is_array($info["img"])): foreach($info["img"] as $key=>$row): ?><span>
                                                <img src="<?php echo ($row); ?>" style="width:160px;height:160px;" class="img-thumbnail" alt="养殖展示图片">
                                                <input type="hidden" name="img[]" value="<?php echo ($row); ?>">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-footer">
                                        <script id="ueditor" style="width:100%;height:400px;"
                                                type="text/plain"><?php echo ($info["description"]); ?></script>
                                    </div>
