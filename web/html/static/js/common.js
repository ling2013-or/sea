...
function buildUrl(e, t) {
    switch (e) {
        case"keyword":
            return farm + "/tmpl/product_list.html?keyword=" + encodeURIComponent(t);
        case"special":
            return farm + "/special.html?special_id=" + t;
        case"goods":
            return farm + "/goods/detail.html?goods_id=" + t;
        case"plans":
            return farm + "/seed/detail.html?goods_id=" + t;
        case"url":
            return t
    }
    return WapSiteUrl
...
function getFreeVoucher(e) {
    ...
    $.ajax({
        ...
        success: function (e) {
            ...
            $.sDialog({skin: a, content: t, okBtn: false, cancelBtn: false})
        }
    })
}
...
function getChatCount() {
    if ($("#header").find(".message").length > 0) {
        var e = getCookie("key");
        if (e !== null) {
            $.getJSON(ApiUrl + "/index.php?act=member_chat&op=get_msg_count", {key: e}, function (e) {
                if (e.datas > 0) {
        ...
        $("#header").find(".message").parent().click(function () {
            window.location.href = farm + "/common/message_list.html"
        })
    }
}
$(function () {
    ...
    $.extend($, {
        scrollTransparent: function (e) {
            ...
            function _getAreaList() {
                ...
                $.ajax({
                    type: "post",
                    url: ApiUrl + "/area/lists.html",
                    data: {token:token,area_id: ASID},
                    dataType: "json",
                    async: false,
                    success: function (e) {//console.log(e);
                        ...
                        for (var n = 0; n < t.length; n++) {
                            a += '<li><a href="javascript:void(0);" data-id="' + t[n].area_id + '" data-name="' + t[n].area_name + '"><h4>' + t[n].area_name + '</h4><span class="arrow-r"></span> </a></li>'
                        }
                        $("#areaSelected").find(".nctouch-default-list").html(a);
                        if (typeof myScrollArea == "undefined") {
                            if (typeof IScroll == "undefined") {
                                $.ajax({url: server+"/html/static/js/iscroll.js", dataType: "script", async: false})
                            }
            ...
            var t = {valve: ".animation-left", wrapper: ".nctouch-full-mask", scroll: ""};
            var e = $.extend({}, t, e);
            //console.log(e);
            function a() {
                $(e.valve).click(function () {
                    ...
                    if (e.scroll != "") {
                        if (typeof myScrollAnimationLeft == "undefined") {
                            ...
                            myScrollAnimationLeft = new IScroll(e.scroll, {mouseWheel: true, click: true})
                        } else {
            ...
            function a() {
                ...
                if (e.scroll != "") {
                    if (typeof myScrollAnimationUp == "undefined") {
                        ...
                        myScrollAnimationUp = new IScroll(e.scroll, {mouseWheel: true, click: true})
                    } else {
