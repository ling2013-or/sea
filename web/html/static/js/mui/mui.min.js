...
!function (a, b) {
    ...
    a.ajax = function (d, e) {
        ...
        var m, n = f.accepts[h.toLowerCase()], r = {}, s = function (a, b) {
            r[a.toLowerCase()] = [a, b]
    ...
    var c = "mui-slider", d = "mui-slider-group", e = "mui-slider-loop", f = "mui-slider-indicator", g = "mui-action-previous", h = "mui-action-next", i = "mui-slider-item", j = "mui-active", k = "." + i, l = "." + f, m = ".mui-slider-progress-bar", n = a.Slider = a.Scroll.extend({
        init: function (b, c) {
            ...
            if (b.target === c.wrapper) {
                ...
                if (m) {
                    ...
                    if (n.length > 0)for (var g = 0, h = n.length; h > g; g++)n[g].classList[g === d.slideNumber ? "add" : "remove"](j); else {
                        ...
                        if (o)o.innerText = d.slideNumber + 1; else for (var p = c.wrapper.querySelectorAll(".mui-control-item"), g = 0, h = p.length; h > g; g++)p[g].classList[g === d.slideNumber ? "add" : "remove"](j)
                    }
                }
                b.stopPropagation()
            }
            ...
            return this.loop ? a > this.itemLength - (b ? 2 : 3) ? (a = 1,
                time = 0) : (b ? -1 : 0) > a ? (a = this.itemLength - 2, time = 0) : a += 1 : (b || (a > this.itemLength - 1 ? (a = 0, time = 0) : 0 > a && (a = this.itemLength - 1, time = 0)), a = Math.min(Math.max(0, a), this.itemLength - 1)), this.pages[a][0]
