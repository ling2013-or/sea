...
function() {
	...
	function(a, b, c) {
		var d = "mui-popup",
			...
			r = function(a) {
				var myInputType = a || 'text';
				var myInputplaceholder = a=='password'?'':a;
				return '<div class="' + k + '"><input type="'+myInputType+'" autofocus placeholder="' + (myInputplaceholder || "") + '" autofocus /></div>'
			},
			s = function(a, b, c) {
