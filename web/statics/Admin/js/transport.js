$(function(){
	...
	TransTpl += "元， 每增加\n";
	TransTpl += "<input class=\"w30 ml5 mr5 text\" type=\"text\" aria-label=\"每加重量\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"plus\" name=\"default[TRANSTYPE][plus]\">\n";
	TransTpl += "kg， 增加运费\n";
	TransTpl += "<input class=\"w50 ml5 text\" type=\"text\" aria-label=\"加重量运费\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postageplus\" name=\"default[TRANSTYPE][postageplus]\">";
	TransTpl += "元";
	...
	SpecialMessage += "<span  error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>首重量应输入1至9999的数字<\/span>\n";
	...
	SpecialMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>续重量应输入1至9999的数字<\/span>\n";
	...
	DefaultMessage = '';
	DefaultMessage += "<span error_type=\"start\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>首重量应输入1至9999的数字<\/span>\n";
	...
	DefaultMessage += "<span error_type=\"plus\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>续重量应输入1至9999的数字<\/span>\n";
	...
	RuleHead += "<tr>\n";
	RuleHead += "<th>运送到<\/th>\n";
	RuleHead += "<th class=\"w60\">首重(kg)<\/th>\n";
	RuleHead += "<th class=\"w110\">首费(元)<\/th>\n";
	RuleHead += "<th class=\"w60\">续重(kg)<\/th>\n";
...
//	RuleCell += "<a class=\"ncu-btn2\" title=\"编辑运送区域\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">编辑<\/a>\n";
	...
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w60\" type=\"text\" aria-label=\"首费\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postage\" name=\"special[TRANSTYPE][CurNum][postage]\">";
	...
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w60\" type=\"text\" aria-label=\"续费\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postageplus\" name=\"special[TRANSTYPE][CurNum][postageplus]\">";
